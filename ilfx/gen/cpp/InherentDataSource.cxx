...
namespace inherent
{
  namespace datasource
  {
    ...
    const DetailRowType::eligible_type& DetailRowType::
    eligible () const
    {
      return this->eligible_.get ();
    }

    DetailRowType::eligible_type& DetailRowType::
    eligible ()
    {
      return this->eligible_.get ();
    }
    ...
    void DetailRowType::
    eligible (const eligible_type& x)
    {
      this->eligible_.set (x);
    }
  }
}
  ...
  namespace datasource
  {
           ...
           ::xml_schema::flags f)
    {
      for (; p.more_content (); p.next_content (false))
      {
        ...
        // eligible
        //
        if (n.name () == "eligible" && n.namespace_ () == "http://example.com/inherent")
        {
          if (!eligible_.present ())
          {
            this->eligible_.set (eligible_traits::create (i, f, this));
            continue;
          }
        }
