 ...
 */
SourceData *risk_profile_data_new(const gchar *profile_id, const gchar *risiko_name,
                                       const gchar *faktor_penilaian, xmlNodePtr xml_node);
 ...
 */
void risk_profile_data_free(SourceData *data);
